# PM SKILLS ChatGPT Project Bootstrap
...
- File: `projects/pm-skills/project-profile.yaml`
- Profile ID: `pm-skills`
- Repository: `TO_BE_CONFIRMED/myskills`
- Default branch: `main`
- Write enabled: `false`
- Repository identity status: `unconfirmed`

Active Project Extension:

- File: `projects/pm-skills/project-extension.md`
...
**Write lock:** repository owner/URL is unconfirmed in the profile. Repository writes are prohibited until the profile is revised and revalidated.
