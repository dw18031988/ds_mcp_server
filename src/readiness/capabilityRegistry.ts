...
export const CAPABILITY_DEFINITIONS: CapabilityDefinition[] = [
  ...
  { name: "github_list_workflow_runs", transport: "mcp", read_only: true, write_capable: false, required_gate: null, requires_auth: true },
  { name: "github_get_workflow_run", transport: "mcp", read_only: true, write_capable: false, required_gate: null, requires_auth: true },
  { name: "github_list_workflow_run_jobs", transport: "mcp", read_only: true, write_capable: false, required_gate: null, requires_auth: true },
  ...
  { name: "github_list_check_runs_for_ref", transport: "mcp", read_only: true, write_capable: false, required_gate: null, requires_auth: true },
